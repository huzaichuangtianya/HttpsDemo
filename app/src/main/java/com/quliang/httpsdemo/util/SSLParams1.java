package com.quliang.httpsdemo.util;
...
/**
 * Created by quliang on 18-8-1.
 */

public class SSLParams1 {

    public static class QSSLParams {
    ...
    public static HttpsUtils.SSLParams getSslSocketFactoryBase(X509TrustManager trustManager, InputStream bksFile, String password, InputStream... certificates) {
